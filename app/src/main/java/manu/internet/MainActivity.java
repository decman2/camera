...
public class MainActivity extends AppCompatActivity {
    ...
    CameraCaptureSession.CaptureCallback stateCallbackSession = new CameraCaptureSession.CaptureCallback() {
        @Override
        public void onCaptureStarted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, long timestamp, long frameNumber) {
            super.onCaptureStarted(session, request, timestamp, frameNumber);
//            TestThread t = new TestThread(reader);
//            t.start();
//            System.out.println(reader.acquireLatestImage().toString());
...
//            surfaces.add(surface);
    ...
    private void updatePreview() {
        ...
        try{
            cameraCaptureSessions.setRepeatingRequest(captureRequestBuilder.build(),stateCallbackSession,mBackgroundHandler);
